...
> 2. **QC review** — inspect QC figures and `checkpoint/qc_review/qc_review.md`; revise thresholds if needed. On **paired**, this checkpoint also documents the S3 union doublet policy.
